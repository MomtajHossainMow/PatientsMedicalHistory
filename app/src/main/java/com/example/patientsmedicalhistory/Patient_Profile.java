...
public class Patient_Profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Patient Profile Modify");

        //----------Copied DatePicker code for DOB--------------------------------------------------
        dateButton = findViewById(R.id.patient_profile_dob);
        initDatePicker();
        ...
        address = findViewById(R.id.patient_profile_address);
        nid = findViewById(R.id.patient_profile_nid);
        dob = findViewById(R.id.patient_profile_dob);
        contact = findViewById(R.id.patient_profile_phone);
        mail = findViewById(R.id.patient_profile_mail);
        ...
        databaseReference.child("Patient").addListenerForSingleValueEvent(new ValueEventListener()
        {
            ...
            {
                Toast.makeText(Patient_Profile.this, "User Data Retrieval Failed", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                databaseReference.child("Patient").child(anid).updateChildren(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void unused) {
                        Toast.makeText(Patient_Profile.this, "Data is Successfully Updated", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(Patient_Profile.this, PatientPanel.class);
                        intent.putExtra("PatientID",anid );
                ...
                new AlertDialog.Builder(Patient_Profile.this)
                        ...
                        .setPositiveButton("YES", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                databaseReference.child("Patient").child(ID).removeValue();
                                Toast.makeText(Patient_Profile.this, "Your Patient Profile Is Deleted.", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(Patient_Profile.this, Patient_Login.class);
                                startActivity(intent);
                                finish();
                            }
                        })
