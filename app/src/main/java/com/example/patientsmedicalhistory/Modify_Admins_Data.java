...
public class Modify_Admins_Data extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modify_admins_data);
        setTitle("Modify Admin ID");

        //----------Copied DatePicker code for DOB--------------------------------------------------
        dateButton = findViewById(R.id.admin_profile_dob);
        initDatePicker();
        ...
        name = findViewById(R.id.admin_profile_name);
        address = findViewById(R.id.admin_profile_address);
        nid = findViewById(R.id.admin_profile_nid);
        dob = findViewById(R.id.admin_profile_dob);
        contact = findViewById(R.id.admin_profile_phone);
        mail = findViewById(R.id.admin_profile_main);
        ...
        databaseReference.child("Admins").addListenerForSingleValueEvent(new ValueEventListener()
        {
            ...
            {
                Toast.makeText(Modify_Admins_Data.this, "User Data Retrieval Failed", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                databaseReference.child("Admins").child(anid).updateChildren(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void unused) {
                        Toast.makeText(Modify_Admins_Data.this, "Data is Successfully Updated", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                });
            }
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new AlertDialog.Builder(Modify_Admins_Data.this)
                        .setTitle("Delete Admin Profile")
                        .setMessage("Are you sure you want to delete this profile?")
                        .setPositiveButton("YES", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                // Continue with delete operation
                                databaseReference.child("Admins").child(ID).removeValue();
                                Toast.makeText(Modify_Admins_Data.this, "Your Admin Profile Is Deleted.", Toast.LENGTH_SHORT).show();
                                finish();
                            }
                        })
