...
public class Admin_Profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.child("Admins").addListenerForSingleValueEvent(new ValueEventListener()
        {
            ...
            {
                Toast.makeText(Admin_Profile.this, "User Data Retrieval Failed", Toast.LENGTH_SHORT).show();
            }
        });
            ...
            public void onClick(View v) {
                ...
                databaseReference.child("Admins").child(anid).updateChildren(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        Toast.makeText(Admin_Profile.this, "Data is Successfully Updated", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(Admin_Profile.this, Admin_Panel.class);
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new AlertDialog.Builder(Admin_Profile.this)
                        ...
                        .setPositiveButton("YES", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Toast.makeText(Admin_Profile.this, "Your Admin Profile Is Deleted.", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(Admin_Profile.this, Admin_Login.class);
                                startActivity(intent);
                                finish();
                            }
                        })
