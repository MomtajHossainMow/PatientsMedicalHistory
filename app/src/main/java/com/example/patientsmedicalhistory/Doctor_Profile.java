...
public class Doctor_Profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Doctor Profile Manage");
        ...
        databaseReference.child("Doctors").addListenerForSingleValueEvent(new ValueEventListener()
        {
            ...
            {
                Toast.makeText(Doctor_Profile.this, "User Data Retrieval Failed", Toast.LENGTH_SHORT).show();
            }
        });
            ...
            public void onClick(View v) {
                ...
                databaseReference.child("Doctors").child(anid).updateChildren(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        Toast.makeText(Doctor_Profile.this, "Data is Successfully Updated", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(Doctor_Profile.this, Doctor_Panel.class);
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new AlertDialog.Builder(Doctor_Profile.this)
                        ...
                        .setPositiveButton("YES", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Toast.makeText(Doctor_Profile.this, "Your Doctor Profile Is Deleted.", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(Doctor_Profile.this, Doctor_Login.class);
                                startActivity(intent);
                                finish();
                            }
                        })
